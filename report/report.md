...
Business Understanding and Data Understanding use the original set of features from the dataset while evaluating the problem and examinig the data. 
...
The routing and map display are implemented using the javascript Google Maps API. The scoring display is implemented using google maps markers with the intersection scores retreived from the scoring server. 
