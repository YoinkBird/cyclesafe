...
<!--!@breadcrumb-->
<!--<@breadcrumb>-->
| [table-of-content](#table-of-content) | [meta](#meta) | [abstract](#abstract) | [introduction](#introduction) | [background-and-results-to-date](#background-and-results-to-date) | [goals](#goals) | [roadway-safety-analysis](#roadway-safety-analysis) | [methodology](#methodology) | [crisp-dm-report](#crisp-dm-report) | [technical-implementation](#technical-implementation) | [discussion--conclusion](#discussion--conclusion) | [future-work](#future-work) | [acknowledgements](#acknowledgements) | [reference--literature-bibliography](#reference--literature-bibliography) | [appendix](#appendix) | 
<!--</@breadcrumb>-->
...
## Introduction to Data Mining
First, a brief overview of the datamining process.  
...
**Framework**  
The following CRISP-DM stages depend on a framework developed for managing the dataset for this project. 

The Data Understanding and Data Preparation stages of CRISP-DM address the exact types of features used for training the model and why.  

The list of features is important during each stage of the project, and the relevant list can change throughout the CRISP-DM cycles.  
Data Understanding deals with the full list of features, whereas Data Preparation can remove or add features as needed, and Modelling uses a fixed set of features.  
<!--
@TODO: feature vs predictor
-->
To manage this changing list of features, a python module was created to centralise and abstract the feature management.  
Many projects simply hard-code the list of features several times throughout the different stages, but this becomes unwieldly as the features change.  
The approach taken by this project makes it simple for each stage to select its relevant features while simulataneously facilitating the addition of new features.  

The feature descriptions are manged by a pandas dataframe in feature_definitions.py (featdef).  
A dataframe is a structure to store and query data which greatly facilitates data manipulation.  
The featdef dataframe tracks various attributes assigned to the features used in this project, and the query language is used to return a list of features for a given set of attributes.  
This abstraction for managing features avoids the need to hard-code the feature lists as previously mentioned.  
The most common application of this is during the test-train split, where the list of training features can simply be generated by querying for all non-target features, and the list of target features by querying for target features.  

This framework will be referenced in context throughout these CRISP-DM stage descriptions, 
...
**Framework: Data Preparation - select:**  
...
**Framework: Data Preparation - clean:**  
